...
public class lugar3_1 : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerPrefs.SetInt("etotal5_3", 0);
        PlayerPrefs.SetInt("atotal5_3", 0);
        PlayerPrefs.SetFloat("ttotal5_3", 0);
    ...
    void Update()
    {
        ...
        if (fb1 == 1)
        {
            PlayerPrefs.SetFloat("ttotal5_3", t);
            PlayerPrefs.SetInt("etotal5_3", c_errores);
            PlayerPrefs.SetInt("atotal5_3", c_aciertos);
            Application.LoadLevel("lugar3_2");
        }
    }
    public void objeto1()
    {
