...
public class cima2_2 : MonoBehaviour
{
    public AudioSource sgood, sbad;
    public float tv, tiempo, tb, tp, te, tg, tq, ts, ta, ti, t1, t2, t3, t4, tiempo2, tiempo3, t = 0.0f;
    public GameObject good1, good2, good3, good4, bad1, bad2, bad3, bad4, bad5, bad6, bad7, bad8;
    ...
    void Start()
    {
        c_errores = PlayerPrefs.GetInt("etotal6_2");
        c_aciertos = PlayerPrefs.GetInt("atotal6_2");
        t = PlayerPrefs.GetFloat("ttotal6_2");
        ec = "eclima2" + PlayerPrefs.GetString("nu");
        ac = "aclima2" + PlayerPrefs.GetString("nu");
        tc = "tclima2" + PlayerPrefs.GetString("nu");
