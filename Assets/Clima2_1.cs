...
public class Clima2_1 : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerPrefs.SetInt("etotal6_2", 0);
        PlayerPrefs.SetInt("atotal6_2", 0);
        PlayerPrefs.SetFloat("ttotal6_2", 0);
    ...
    void Update()
    {
        ...
        if (fb1 == 1 && fb2 == 1 && fb3 == 1 && fb4 == 1)
        {
            if (c_aciertos > 4)
                c_aciertos = 4;
            PlayerPrefs.SetFloat("ttotal6_2", t);
            PlayerPrefs.SetInt("etotal6_2", c_errores);
            PlayerPrefs.SetInt("atotal6_2", c_aciertos);
            Application.LoadLevel("clima2_2"); ;
        }
