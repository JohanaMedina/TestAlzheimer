...
public class seleccionar7 : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerPrefs.SetInt("etotal2_3", 0);
        PlayerPrefs.SetInt("atotal2_3", 0);
        PlayerPrefs.SetFloat("ttotal2_3", 0);
    ...
    void Update()
    {
        ...
        {
            PlayerPrefs.SetFloat("ttotal2_3", t);
            PlayerPrefs.SetInt("etotal2_3", c_errores);
            PlayerPrefs.SetInt("atotal2_3", c_aciertos);
            Application.LoadLevel("secuencias8");
        }
    }
    public void objeto1()
    {
