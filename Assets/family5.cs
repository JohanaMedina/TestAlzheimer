...
public class family5 : MonoBehaviour
{
    ...
    public int bien1 = 0, f = 0, a = 0, b = 0, cont4 = 0, fv = 0, s = 0,f1=0;
    public Animation objet, giro;
    public Material inicio, goodm, badm;
    public AudioSource sgood, sbad;
    public family4 cont3;
    public int c_errores = 0, c_aciertos = 0;
    public string tc, ec, ac;
    void Start()
    {
        
        ec = "ecaras1" + PlayerPrefs.GetString("nu");
        ac = "acaras1" + PlayerPrefs.GetString("nu");
        tc = "tcaras1" + PlayerPrefs.GetString("nu");
