...
public class afirmacion : MonoBehaviour
{
    public AudioSource sgood, sbad, afirmation;
    public float tiempo, t1, t2, tiempo2,t=0.0f;
    ...
    void Start()
    {
        PlayerPrefs.SetInt("etotal3", 0);
        PlayerPrefs.SetInt("atotal3", 0);
        PlayerPrefs.SetFloat("ttotal3", 0);
        ...
        if (tiempo < 0)
        {
            ...
            tiempo2 -= Time.deltaTime;
                if (tiempo2 < 0)
                {
                    ...
                    Application.LoadLevel("afirmaciones2");
                }
            }
