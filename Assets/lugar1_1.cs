...
public class lugar1_1 : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerPrefs.SetInt("etotal5", 0);
        PlayerPrefs.SetInt("atotal5", 0);
        PlayerPrefs.SetFloat("ttotal5", 0);
    ...
    void Update()
    {
        ...
        if (tiempo < 0)
        {
            if (tv < 0 || tp < 0 || te < 0 || tg < 0 || tq < 0 || ts < 0 || ta < 0 || ti < 0)
            {
                ...
                if (bien1 == 4)
                {
                    ...
                    bad4.GetComponent<MeshRenderer>().material = badm; s = 0;
                    bien1 = 0;
                    tv = 2.0f;
                    fv = 0;
                    tp = 2.0f;
        ...
        if (fb1 == 1)
        {
            PlayerPrefs.SetFloat("ttotal5", t);
            PlayerPrefs.SetInt("etotal5", c_errores);
            PlayerPrefs.SetInt("atotal5", c_aciertos);
            Application.LoadLevel("lugar1_2");
        }
    }
    public void objeto1()
    {
