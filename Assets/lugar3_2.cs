...
public class lugar3_2 : MonoBehaviour
{
    public AudioSource sgood, sbad;
    public float tv, tiempo, tb, tp, te, tg, tq, ts, ta, ti, t1, t3, t2, t4, t5, t6, t7, tiempo2, tiempo3, t = 0.0f;
    public GameObject good1, bad1, bad2, bad3, bad4, bad5, bad6, bad7, bad8, bad9, bad10, bad11, bad12, bad13, bad14, opciones;
    ...
    void Start()
    {
        c_errores = PlayerPrefs.GetInt("etotal5_3");
        c_aciertos = PlayerPrefs.GetInt("atotal5_3");
        t = PlayerPrefs.GetFloat("ttotal5_3");
        ec = "elugar3" + PlayerPrefs.GetString("nu");
        ac = "alugar3" + PlayerPrefs.GetString("nu");
        tc = "tlugar3" + PlayerPrefs.GetString("nu");
        ...
        bad13.GetComponent<MeshRenderer>().material = inicio;
        bad14.GetComponent<MeshRenderer>().material = inicio;
    ...
    void Update()
    {
        ...
        if (tiempo < 0)
        {
            if (tv < 0 || tp < 0 || te < 0 || tg < 0 || tq < 0 || ts < 0 || ta < 0 || ti < 0 || t1 < 0 || t2 < 0 || t3 < 0 || t4 < 0 || t5 < 0 || t6 < 0 || t7 < 0)
            {
                if (bien1 == 13)
                {
                    if (s == 0)
                ...
                if (bien1 == 14)
                {
                    ...
                    bad13.GetComponent<MeshRenderer>().material = badm;
                    s = 0;
                    bien1 = 0;
                    tv = 2.0f;
                    fv = 0;
                ...
                if (bien1 == 15)
                {
                    ...
                    bad14.GetComponent<MeshRenderer>().material = badm;
                    s = 0;
                    bien1 = 0;
                    tv = 2.0f;
                    fv = 0;
