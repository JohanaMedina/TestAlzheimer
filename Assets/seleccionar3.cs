...
public class seleccionar3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ec = "esecuencia1" + PlayerPrefs.GetString("nu");
        ac = "asecuencia1" + PlayerPrefs.GetString("nu");
        tc = "tsecuencia1" + PlayerPrefs.GetString("nu");
        t1 = 2.0f;
        t2 = 2.0f;
        t3 = 2.0f;
        t4 = 2.0f;
    ...
    void Update()
    {
        ...
        if (cont == 1 && !sgood.isPlaying)
        {
            ...
            Application.LoadLevel("afirmaciones");
        }
    }
    public void objeto1()
    {
