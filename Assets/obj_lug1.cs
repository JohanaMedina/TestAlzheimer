...
public class obj_lug1 : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerPrefs.SetInt("etotal3_3", 0);
        PlayerPrefs.SetInt("atotal3_3", 0);
        PlayerPrefs.SetFloat("ttotal3_3", 0);
    ...
    void Update()
    {
        ...
        if (fb1 == 1 && fb2 == 1 && fb3 == 1 && fb4 == 1 && fb5 == 1) 
        {
            ...
            Application.LoadLevel("obj_lug2");
        }
