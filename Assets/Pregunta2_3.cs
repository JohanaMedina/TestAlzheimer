...
public class Pregunta2_3 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        ec = "ehistoria2" + PlayerPrefs.GetString("nu");
        ac = "ahistoria2" + PlayerPrefs.GetString("nu");
        tc = "thistoria2" + PlayerPrefs.GetString("nu");
