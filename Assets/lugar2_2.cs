...
public class lugar2_2 : MonoBehaviour
{
    ...
    void Start()
    {
        c_errores = PlayerPrefs.GetInt("etotal5_2");
        c_aciertos = PlayerPrefs.GetInt("atotal5_2");
        t = PlayerPrefs.GetFloat("ttotal5_2");
        ec = "elugar2" + PlayerPrefs.GetString("nu");
        ac = "alugar2" + PlayerPrefs.GetString("nu");
        tc = "tlugar2" + PlayerPrefs.GetString("nu");
    ...
    void Update()
    {
        ...
        if (fb1 == 1)
        {
            ...
            Application.LoadLevel("clima2_1");
        }
    }
    public void objeto1()
    {
