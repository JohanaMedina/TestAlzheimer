...
public class Pregunta2_1 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        PlayerPrefs.SetInt("etotal1_2", 0);
        PlayerPrefs.SetInt("atotal1_2", 0);
        PlayerPrefs.SetFloat("ttotal1_2", 0);
    ...
    void Update()
    {
        ...
        if (fb1 == 1)
        {
            ...
            if (tiempo3 < 0)
            {
                ...
                Application.LoadLevel("Respuestas2_2");
            }
