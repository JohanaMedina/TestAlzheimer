...
public class plan1 : MonoBehaviour {
    ...
    public float tiempo, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, tb, fb = 0,t=0.0f;
    public int f, fv,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10;
    ...
    void Start () {
        ...
        ec = "eplan1" + PlayerPrefs.GetString("nu");
        ac = "aplan1" + PlayerPrefs.GetString("nu");
        tc = "tplan1" + PlayerPrefs.GetString("nu");
