...
public class afirmacion4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ec = "eafirmacion1" + PlayerPrefs.GetString("nu");
        ac = "aafirmacion1" + PlayerPrefs.GetString("nu");
        tc = "tafirmacion1" + PlayerPrefs.GetString("nu");
