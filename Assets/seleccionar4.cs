...
public class seleccionar4 : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerPrefs.SetInt("etotal2_2", 0);
        PlayerPrefs.SetInt("atotal2_2", 0);
        PlayerPrefs.SetFloat("ttotal2_2", 0);
    ...
    void Update()
    {
        ...
        {
            PlayerPrefs.SetFloat("ttotal2_2", t);
            PlayerPrefs.SetInt("etotal2_2", c_errores);
            PlayerPrefs.SetInt("atotal2_2", c_aciertos);
            Application.LoadLevel("secuencias5");
        }
    }
    public void objeto1()
    {
