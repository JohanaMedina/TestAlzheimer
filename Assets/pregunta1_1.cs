...
public class pregunta1_1 : MonoBehaviour {
    ...
    public int f, fv, bien1, fb1 = 0, s = 0, fa = 1;
    public Material inicio, goodm, badm;
    public int c_errores = 0, c_aciertos = 0, f1 = 0;

    void Start()
    {
        PlayerPrefs.SetInt("etotal1", 0);
        PlayerPrefs.SetInt("atotal1", 0);
        PlayerPrefs.SetFloat("ttotal1", 0);
    ...
    void Update()
    {
        ...
        if (fb1 == 1)
        {
            ...
            if(tiempo3 < 0)
            {
                PlayerPrefs.SetFloat("ttotal1", t);
                PlayerPrefs.SetInt("etotal1", c_errores);
                PlayerPrefs.SetInt("atotal1", c_aciertos);
                Application.LoadLevel("Respuestas1_2");
            }
