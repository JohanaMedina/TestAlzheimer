...
public class obj_lug3 : MonoBehaviour
{
    ...
    public GameObject good1, good2, good3, good4, good5, good6, bad1, bad2, bad3, bad4, bad5, bad6, bad7, bad8, bad9, bad10;
    public int f, fv, bien1, fb1 = 0, fb2 = 0, fb3 = 0, fb4 = 0, fb5 = 0, fb6=0, s = 0;
    ...
    void Start()
    {
        ...
        ec = "eobjlugar1" + PlayerPrefs.GetString("nu");
        ac = "aobjlugar1" + PlayerPrefs.GetString("nu");
        tc = "tobjlugar1" + PlayerPrefs.GetString("nu");
        ...
        good6.GetComponent<MeshRenderer>().material = inicio;
    ...
    void Update()
    {
        ...
        if (tiempo < 0)
        {
            if (tv < 0 || tp < 0 || te < 0 || tg < 0 || tq < 0 || ts < 0 || ta < 0 || ti < 0 || t1 < 0 || t2 < 0 || t3 < 0 || t4 < 0 || t5 < 0 || t6 < 0 || t7 < 0 || t8 < 0)
            {
                ...
                if (bien1 == 16)
                {
                    ...
                    good6.GetComponent<MeshRenderer>().material = goodm;
                    fb6 = 1;
                    s = 0;
                    bien1 = 0;
                    tv = 2.0f;
        ...
        if (fb1 == 1 && fb2 == 1 && fb3 == 1 && fb4 == 1 && fb5 == 1 && fb6==1)
        {
            ...
            Application.LoadLevel("obj_voz3");
        }
