...
public class obj_mez3_1 : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerPrefs.SetInt("etotal4_3", 0);
        PlayerPrefs.SetInt("atotal4_3", 0);
        PlayerPrefs.SetFloat("ttotal4_3", 0);
    ...
    void Update()
    {
        ...
        {
            PlayerPrefs.SetFloat("ttotal4_3", t);
            PlayerPrefs.SetInt("etotal4_3", c_errores);
            PlayerPrefs.SetInt("atotal4_3", c_aciertos);
            Application.LoadLevel("Figuras3_2");
        }
