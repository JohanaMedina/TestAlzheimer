...
public class obj_mez2_1 : MonoBehaviour
{
    ...
    void Start()
    {
        PlayerPrefs.SetInt("etotal4_2", 0);
        PlayerPrefs.SetInt("atotal4_2", 0);
        PlayerPrefs.SetFloat("ttotal4_2", 0);
    ...
    void Update()
    {
        ...
        {
            PlayerPrefs.SetFloat("ttotal4_2", t);
            PlayerPrefs.SetInt("etotal4_2", c_errores);
            PlayerPrefs.SetInt("atotal4_2", c_aciertos);
            Application.LoadLevel("Figuras2_2");
        }
