...
public class atonimos1 : MonoBehaviour {

    public AudioSource sgood, sbad;
    public float tb, tiempo, t1, t2, t3, tiempo2 = 2.0f, t = 0.0f;
    ...
    void Start()
    {
        PlayerPrefs.SetInt("etotal3_2", 0);
        PlayerPrefs.SetInt("atotal3_2", 0);
        PlayerPrefs.SetFloat("ttotal3_2", 0);
    ...
    void Update()
    {
        ...
        if (fb1 == 1 )
        {
            ...
            if (tiempo2 < 0)
            {
                PlayerPrefs.SetFloat("ttotal3_2", t);
                PlayerPrefs.SetInt("etotal3_2", c_errores);
                PlayerPrefs.SetInt("atotal3_2", c_aciertos);
                Application.LoadLevel("antonimos2");
            }
        }
