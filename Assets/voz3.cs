...
public class voz3 : MonoBehaviour
{
    public AudioSource sobj1, sobj2, sobj3, sobj4, sobj5;
    public float t1, tiempo, tb, t2, t3, t4, tiempo2, tiempo3, tiempo4, tiempo5, t = 0.0f;
    public float t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26,t27,t28,t29,t30;
    public GameObject visto, mal, objs1, objs2, objs3, objs4, objs5;
    public GameObject bie1, bien2, bien3, bien4, bien5, mal1, mal2, mal3, mal4, mal5, mal6, mal7, mal8, mal9, mal10, mal11, mal12, mal13, mal14, mal15, mal16, mal17, mal18, mal19, mal20, mal21, mal22, mal23, mal24, mal25;
    public int f, fv, bien, bien1, a = 0, cont = 0, fin = 0, fin2 = 0, next = 0, s = 0;
    public Animation empezar1, empezar2, empezar3, empezar4, empezar5;
    ...
    void Start()
    {
        ec = "evoz3" + PlayerPrefs.GetString("nu");
        ac = "avoz3" + PlayerPrefs.GetString("nu");
        tc = "tvoz3" + PlayerPrefs.GetString("nu");
        ...
        mal18.GetComponent<MeshRenderer>().material = inicio;
        mal19.GetComponent<MeshRenderer>().material = inicio;
        mal20.GetComponent<MeshRenderer>().material = inicio;
        mal21.GetComponent<MeshRenderer>().material = inicio;
        mal22.GetComponent<MeshRenderer>().material = inicio;
        mal23.GetComponent<MeshRenderer>().material = inicio;
        mal24.GetComponent<MeshRenderer>().material = inicio;
        mal25.GetComponent<MeshRenderer>().material = inicio;
    ...
    void Update()
    {
        ...
        {
            if (t1 < 0 || t2 < 0 || t3 < 0 || t4 < 0 || t5 < 0 || t6 < 0 || t7 < 0 || t8 < 0 || t9 < 0 || t10 < 0 || t11 < 0 || t12 < 0 || t13 < 0 || t15 < 0 || t14 < 0 || t16 < 0 || t17 < 0 || t18 < 0 || t19 < 0 || t20 < 0 || t21 < 0 || t22 < 0 || t23 < 0 || t24 < 0 || t25 < 0 || t26 < 0 || t27 < 0 || t28 < 0 || t29 < 0 || t30 < 0)
            {
                if (bien1 == bien)
                {
                    if (bien1 == 6)
                    ...
                    if (bien1 == 21)
                    {
                        ...
                        mal18.GetComponent<MeshRenderer>().material = badm;
                        s = 0;
                        fv = 0;
                        bien1 = 0;
                        t1 = 2.0f;
                    ...
                    if (bien1 == 22)
                    {
                        ...
                        mal19.GetComponent<MeshRenderer>().material = badm;
                        s = 0;
                        fv = 0;
                        bien1 = 0;
                        t1 = 2.0f;
                    ...
                    if (bien1 == 23)
                    {
                        ...
                        mal20.GetComponent<MeshRenderer>().material = badm;
                        s = 0;
                        fv = 0;
                        bien1 = 0;
                        t1 = 2.0f;
                    ...
                    if (bien1 == 25)
                    {
                        ...
                        mal21.GetComponent<MeshRenderer>().material = badm;
                        s = 0;
                        fv = 0;
                        bien1 = 0;
                        t1 = 2.0f;
                    ...
                    if (bien1 == 26)
                    {
                        ...
                        mal22.GetComponent<MeshRenderer>().material = badm;
                        s = 0;
                        fv = 0;
                        bien1 = 0;
                        t1 = 2.0f;
                    ...
                    if (bien1 == 28)
                    {
                        ...
                        mal23.GetComponent<MeshRenderer>().material = badm;
                        s = 0;
                        fv = 0;
                        bien1 = 0;
                        t1 = 2.0f;
                    ...
                    if (bien1 == 29)
                    {
                        ...
                        mal24.GetComponent<MeshRenderer>().material = badm;
                        s = 0;
                        fv = 0;
                        bien1 = 0;
                        t1 = 2.0f;
                    ...
                    if (bien1 == 30)
                    {
                        ...
                        mal25.GetComponent<MeshRenderer>().material = badm;
                        s = 0;
                        fv = 0;
                        bien1 = 0;
                        t1 = 2.0f;
        ...
        if (fin2 == 1 && !sobj5.isPlaying)
        {
            ...
            //Application.LoadLevel("Figuras3_1");
        }
